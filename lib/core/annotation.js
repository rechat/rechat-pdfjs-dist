...
function (_Annotation2) {
  ...
  function WidgetAnnotation(params) {
    ...
    var additional = dict.get('AA');
    var calculate = additional ? additional.get('C') : _primitives.Dict.empty;
    var JS = calculate ? calculate.get('JS') : null;
    data.additional = {
      calculate: {
        JS: JS
      }
  ...
  _createClass(ButtonWidgetAnnotation, [{
    ...
    value: function _processRadioButton(params) {
      ...
      if ((0, _primitives.isDict)(fieldParent) && fieldParent.has('V')) {
        ...
        var fieldValue = params.dict.get('V');
